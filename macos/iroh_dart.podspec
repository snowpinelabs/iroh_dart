#
# iroh_dart macOS plugin. cargokit builds the owned `irohdart-ffi` staticlib (repo-root
...
Pod::Spec.new do |s|
  ...
  # are visible to DynamicLibrary.process() (see ios/iroh_dart.podspec for the full rationale).
