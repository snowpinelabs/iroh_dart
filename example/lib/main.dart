...
/// Example/verification harness for iroh_dart. On a real device it
...
class _HomePageState extends State<_HomePage> {
  ...
  Future<void> _runEcho() async {
    ...
    try {
      ...
      final payload = Uint8List.fromList('hello from iroh_dart'.codeUnits);
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(title: const Text('iroh_dart example')),
    body: Padding(
